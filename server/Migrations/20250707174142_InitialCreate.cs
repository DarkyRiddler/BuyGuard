        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CookiesJson = table.Column<string>(type: "text", nullable: false),
                    ConsoleLogsJson = table.Column<string>(type: "text", nullable: false),
                    ScreenshotUrl = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueMeta", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssueMeta_Issue_IssueId",
                        column: x => x.IssueId,
